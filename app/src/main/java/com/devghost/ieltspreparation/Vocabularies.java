...
public class Vocabularies extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String url = "https://codemind.live/apps/ielts/vocabularies/vocabulary.json";
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null, response -> {
            ...
            try {
                ...
                for(int x= 0 ; x<response.length(); x++){
                    String word = response.getString(x);




                    hashMap = new HashMap<>();
                    hashMap.put("title",word);
    ...
    private class myAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            title.setText(MessageFormat.format("{0}. {1}", number, Title));
