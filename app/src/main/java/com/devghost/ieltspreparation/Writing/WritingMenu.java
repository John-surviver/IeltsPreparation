...
public class WritingMenu extends Fragment implements View.OnClickListener {
    ...
    TextView begginer,intermediate,advanced;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        begginer.setText(R.string.task_1);
        intermediate.setText(R.string.task_2);
    ...
    private void assignIds() {
        ...
        begginer=view.findViewById(R.id.beginner_txt);
        intermediate=view.findViewById(R.id.intermediate_txt);
        advanced=view.findViewById(R.id.advanced_txt);
