...
public class FreeReadingList extends Fragment {
    ...
    String LOAD_LINK="https://codemind.live/apps/ielts/free_reading/get.php";
    @Override
            ...
            linearLayout.setOnClickListener(view1 -> {
                ...
                if (!idValue.isEmpty()) {
                    try {
                        ...
                        fragmentTransaction.replace(R.id.mainLay, new FreeReadingLoad());
